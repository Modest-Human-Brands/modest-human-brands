      ...
      <div class="flex flex-col gap-1 overflow-hidden transition-all duration-500 ease-in-out md:gap-2" :class="open ? 'max-w-sm opacity-100' : 'max-w-0 opacity-0'">
        ...
        <div class="flex items-center gap-1.5">
          ...
          <NuxtLink
            ...
            external
            class="flex size-7 items-center justify-center rounded-full bg-white/[0.07] text-light-400 transition-colors hover:bg-success-500/20 hover:text-[oklch(76.8%_0.233_130.85)]"
          ...
          <NuxtLink
            ...
            target="_blank"
            rel="noopener"
            class="flex size-7 items-center justify-center rounded-full bg-white/[0.07] text-light-400 transition-colors hover:bg-success-500/20 hover:text-[oklch(72.3%_0.219_149.579)]"
            title="WhatsApp">
          ...
          <NuxtLink
            ...
            target="_blank"
            rel="noopener"
            class="hover:bg-pink-500/20 flex size-7 items-center justify-center rounded-full bg-white/[0.07] text-light-400 transition-colors hover:text-[oklch(71.8%_0.202_349.761)]">
          ...
          <NuxtLink
            ...
            target="_blank"
            rel="noopener"
            class="hover:bg-blue-500/20 flex size-7 items-center justify-center rounded-full bg-white/[0.07] text-light-400 transition-colors hover:text-[oklch(70.7%_0.165_254.624)]">
          ...
          <NuxtLink
            ...
            target="_blank"
            rel="noopener"
            class="flex size-7 items-center justify-center rounded-full bg-white/[0.07] text-light-400 transition-colors hover:bg-alert-500/20 hover:text-[oklch(71.2%_0.194_13.428)]">
