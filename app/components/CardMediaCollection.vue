...
<template>
  <NuxtLink
    ...
    <button
      class="absolute right-3 top-3 z-30 flex size-9 items-center justify-center rounded-full bg-white/10 fill-white opacity-0 blur-sm backdrop-blur-md transition-all duration-500 hover:bg-white hover:fill-black group-hover:opacity-100 group-hover:blur-none"
      aria-label="Share Collection"
      @click="shareMedia">
      <NuxtIcon name="local:link" class="text-[20px]" />
    </button>
