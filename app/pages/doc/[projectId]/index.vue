  ...
  <main class="relative flex size-full overflow-hidden bg-dark-400 pt-2 md:pt-4">
    <div class="flex min-w-0 flex-1 flex-col border-r border-dark-500 bg-dark-400 transition-all duration-300">
      <div
        ...
        <input type="checkbox" class="size-4 cursor-pointer rounded border-white/10 bg-dark-500 accent-accent-500" @change="toggleSelectAll" />
        <span>Name</span>
          ...
          <template v-for="document in documents" :key="document.id">
            <NuxtLink
              ...
              :class="[
                ...
                selectedDocId === document.id ? 'bg-accent-500/10 text-white' : 'text-light-400 hover:bg-white/[0.03]',
              ]"
